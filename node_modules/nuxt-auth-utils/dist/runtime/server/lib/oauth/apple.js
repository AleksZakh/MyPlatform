...
import { handleMissingConfiguration, handleAccessTokenErrorResponse, getOAuthRedirectURL, handleInvalidState, handleState, requestAccessToken, signJwt, verifyJwt } from "../utils.js";
...
export function defineOAuthAppleEventHandler({
  ...
  return eventHandler(async (event) => {
    ...
    let user;
    if (isPost) {
      ({ code, state, user } = await readBody(event));
    }
