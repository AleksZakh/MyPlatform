import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, isRef, computed, watch, shallowRef, isReadonly, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, toValue, onServerPrefetch, ref, nextTick, unref, customRef, resolveComponent, defineAsyncComponent, Fragment, toRefs, renderSlot, toHandlerKey, camelize, Comment, mergeProps, openBlock, createBlock, withCtx, Teleport, createCommentVNode, watchEffect, markRaw, onScopeDispose, createTextVNode, toDisplayString, renderList, createVNode, withModifiers, normalizeProps, guardReactiveProps, normalizeStyle, resolveDynamicComponent, useSSRContext, useAttrs, useTemplateRef, useModel, mergeModels, useSlots, useId, Suspense, withAsyncContext, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "/var/www/html/MyPlatform/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/var/www/html/MyPlatform/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/var/www/html/MyPlatform/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestHeader, setCookie, getCookie, deleteCookie } from "/var/www/html/MyPlatform/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { shouldHydrate, defineStore, setActivePinia, createPinia } from "pinia";
import defu$1, { defu, defuFn } from "/var/www/html/MyPlatform/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash, withLeadingSlash, encodeParam } from "/var/www/html/MyPlatform/node_modules/ufo/dist/index.mjs";
import { appendResponseHeader, appendHeader } from "/var/www/html/MyPlatform/node_modules/h3/dist/index.mjs";
import { debounce } from "/var/www/html/MyPlatform/node_modules/perfect-debounce/dist/index.mjs";
import { hash, isEqual } from "/var/www/html/MyPlatform/node_modules/ohash/dist/index.mjs";
import { isPlainObject } from "@vue/shared";
import { klona } from "/var/www/html/MyPlatform/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1 } from "/var/www/html/MyPlatform/node_modules/@unhead/vue/dist/index.mjs";
import { _api, addAPIProvider, setCustomIconsLoader, getIcon, loadIcon as loadIcon$1, Icon } from "@iconify/vue";
import { parse } from "/var/www/html/MyPlatform/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
...
import { unrefElement, defaultWindow, useMounted, useVModel, useRafFn, onKeyStroke, reactivePick, reactiveOmit, createSharedComposable } from "@vueuse/core";
...
const _routes = [
  {
    name: "ad-browser",
    path: "/ad/browser",
    component: () => import("./_nuxt/browser-ZlvK7aQe.js")
  },
  {
    name: "access-denied",
    path: "/access-denied",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/access-denied-BkBGY65n.js")
  },
  {
    name: "edit",
    path: "/edit",
    component: () => import("./_nuxt/edit-BBPt0H0E.js")
  },
  {
    name: "lab",
    path: "/lab",
    component: () => import("./_nuxt/index-Dh15hvA4.js")
  },
  {
    name: "lab-tests",
    path: "/lab-tests",
    component: () => import("./_nuxt/index-6DR30KJy.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/login-D-HJU7pY.js")
  },
  {
    name: "profile",
    path: "/profile",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/index-Bu2zTgKq.js")
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import("./_nuxt/index-L6Y7owug.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BiDcv78F.js")
  }
];
...
const namedMiddleware = {
  "admin-only": () => import("./_nuxt/admin-only-DM8j12DI.js"),
  auth: () => import("./_nuxt/auth-ByhJp69L.js")
};
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-CL70r2yv.js").then((m) => m.default || m)),
  loader: defineAsyncComponent(() => import("./_nuxt/loader-qDCNdwXT.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-C7IOq1mc.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BQpNUri6.js"));
...
export {
  ...
  Presence_default as f,
  getActiveElement as g,
  useComponentProps as h,
