...
<template>
  <UCard 
    class="flex flex-col h-full transition-all duration-200 hover:-translate-y-1 hover:shadow-md"
    :ui="{ 
      body: 'p-5 flex-1',
      header: 'p-5',
      footer: 'px-5 py-3'
  ...
  >
    ...
    <template #header>
      <div class="flex items-center gap-3">
        <div class="p-2 bg-primary-50 dark:bg-primary-950/50 rounded-lg text-primary">
