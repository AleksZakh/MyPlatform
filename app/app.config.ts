  ...
  ui: {
    ...
    button: {
      ...
      compoundVariants: [
        ...
        },
        {
          color: 'neutral',
          variant: 'outline',
          class: 'ring ring-inset ring-accented text-default bg-transporent hover:bg-transporent hover:shadow-md/20 active:bg-transporent active:shadow-md disabled:bg-transporent aria-disabled:bg-default outline-inverted/25 focus-visible:outline-3 focus-visible:ring-inverted'
        },
        {
          color: 'neutral',
          variant: 'soft',
    ...
    modal: {
      slots: {
        ...
        content: 'bg-default divide-y divide-default flex flex-col focus:outline-none shadow-blue-500/50',
        header: 'flex items-center gap-1.5 px-4 py-2 sm:px-6 min-h-(--ui-header-height)',
        wrapper: '',
        body: 'flex p-2 sm:p-0',
