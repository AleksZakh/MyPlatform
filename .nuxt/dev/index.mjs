...
import { createHooks as createHooks$1 } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/local_adm/Projects/MyPlatform/node_modules/unstorage/drivers/fs.mjs';
import unstorage_47drivers_47redis from 'file:///home/local_adm/Projects/MyPlatform/node_modules/unstorage/drivers/redis.mjs';
import fsDriver from 'file:///home/local_adm/Projects/MyPlatform/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///home/local_adm/Projects/MyPlatform/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/defu/dist/defu.mjs';
...
import { SourceMapConsumer } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/source-map/source-map.js';
import { createHooks } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/hookable/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///home/local_adm/Projects/MyPlatform/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
...
import { getIcons } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///home/local_adm/Projects/MyPlatform/.nuxt/nuxt-icon-server-bundle.mjs';
...
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/local_adm/Projects/MyPlatform/server/assets"}];
...
const _47home_47local_adm_47Projects_47MyPlatform_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/local_adm/Projects/MyPlatform","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/local_adm/Projects/MyPlatform/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', _47home_47local_adm_47Projects_47MyPlatform_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/home/local_adm/Projects/MyPlatform/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/home/local_adm/Projects/MyPlatform/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/local_adm/Projects/MyPlatform/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/local_adm/Projects/MyPlatform/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/local_adm/Projects/MyPlatform/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/home/local_adm/Projects/MyPlatform/public"
      ]
    },
    "http": {
      "domains": []
...
const _289wjib25d5dcyAPk0QgYYaG_Acp_8KkxfSQZYAsZk = defineNitroPlugin((nitroApp) => {
...
const config = {
  url: "ldap://your-dc.domain.local",
  // Адрес контроллера домена
  baseDN: "DC=domain,DC=local",
  // Корневой DN домена
  username: "srv-web-auth@domain.local",
  // Сервисный аккаунт
...
const _iYewtuE5crcn_XXqAor3doaZbjFeKRVmvqTE6zGuaKk = defineNitroPlugin((nitroApp) => {
...
const _TyE_DB1kgD0xzXkx62XrSmsNWJaVJGQ39n9sKAKQY = (nitroApp) => {
...
const _3IcaGGigBEQYf8R9w1wwNU8KhKtdItQhD1Y4446qRX4 = (function(nitro) {
...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"27012-g5KrTFk55cjFjK3RkLIgFgM7YwQ\"",
    "mtime": "2026-05-26T13:07:46.320Z",
    "size": 159762,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"8d542-rV799rXULJR/p13Xeanx28Q6WTI\"",
    "mtime": "2026-05-26T13:07:46.320Z",
    "size": 578882,
    "path": "index.mjs.map"
  }
...
const _1lDZeu = eventHandler((event) => {
...
const _H8y5Mi = defineEventHandler(async (event) => {
...
const _fKDQ0w = eventHandler(async (event) => {
...
const _2J4pX8 = defineCachedEventHandler(async (event) => {
...
const _VBjkN1 = lazyEventHandler(() => {
...
const handlers = [
  ...
  { route: '/api/_auth/session', handler: _fKDQ0w, lazy: false, middleware: false, method: "get" },
  { route: '/api/_nuxt_icon/:collection', handler: _2J4pX8, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _VBjkN1, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_fj4Rsw, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_fj4Rsw, lazy: true, middleware: false, method: undefined }
];
...
const getGroups_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
...
const getUsers_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
