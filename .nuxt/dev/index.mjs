...
import { createStorage, prefixStorage } from 'file:///home/local_adm/Projects/MyPlatform/node_modules/unstorage/dist/index.mjs';
...
const getServerEntry = () => import('file:///home/local_adm/Projects/MyPlatform/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///home/local_adm/Projects/MyPlatform/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
