import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, h, computed, ref, provide, inject, getCurrentInstance, toRefs, toValue, unref, mergeProps, createVNode, resolveDynamicComponent, watch, withCtx, renderSlot, openBlock, createBlock, toDisplayString, isRef, useSlots, createCommentVNode, toRef, useAttrs, useTemplateRef, Comment, cloneVNode, shallowRef, resolveComponent, onServerPrefetch, watchEffect, markRaw, nextTick, Fragment, camelize, useModel, createTextVNode, mergeModels, toHandlerKey, hasInjectionContext, createElementBlock, reactive, defineAsyncComponent, useSSRContext, shallowReactive, Suspense, createApp, renderList, useId, withAsyncContext, onErrorCaptured, effectScope, withModifiers, normalizeProps, guardReactiveProps, normalizeStyle, getCurrentScope, Teleport, onScopeDispose, isReadonly, toRaw, isShallow, isReactive, customRef } from 'vue';
import { q as serialize, t as hasProtocol, v as isScriptProtocol, w as joinURL, x as defu, y as klona, z as withQuery, A as sanitizeStatusCode, B as parseURL, i as encodePath, C as decodePath, D as parseQuery, E as hash, F as defuFn, G as appendResponseHeader, H as isEqual, I as getContext, J as withTrailingSlash, K as withoutTrailingSlash, L as withLeadingSlash, c as createError$1, $ as $fetch$1, M as baseURL, N as createHooks, O as executeAsync, P as encodeParam, Q as getRequestHeader, R as setCookie, S as getCookie, e as deleteCookie } from '../nitro/nitro.mjs';
...
import { unrefElement, reactivePick, defaultWindow, reactiveOmit, onKeyStroke, useVModel, useMounted, createSharedComposable, useRafFn } from '@vueuse/core';
...
const __nuxt_page_meta$2 = {
  public: true
  // ✅ Указываем, что страница публичная
};
...
const __nuxt_page_meta = {
  public: false
  // ❌ Указываем, что страница не публичная
};
const _routes = [
  {
    name: "ad-browser",
    path: "/ad/browser",
    component: () => import('./browser-ZlvK7aQe.mjs')
  },
  {
    name: "access-denied",
    path: "/access-denied",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./access-denied-BkBGY65n.mjs')
  },
  {
    name: "edit",
    path: "/edit",
    component: () => import('./edit-BBPt0H0E.mjs')
  },
  {
    name: "lab",
    path: "/lab",
    component: () => import('./index-Dh15hvA4.mjs')
  },
  {
    name: "lab-tests",
    path: "/lab-tests",
    component: () => import('./index-6DR30KJy.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./login-D-HJU7pY.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-Bu2zTgKq.mjs')
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import('./index-L6Y7owug.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BiDcv78F.mjs')
  }
];
...
const useAuthStore = defineStore("auth", {
  ...
  getters: {
    ...
    getMyName: (state) => state.user.name,
    getMyEmail: (state) => state.user.email,
...
const namedMiddleware = {
  "admin-only": () => import('./admin-only-DM8j12DI.mjs'),
  auth: () => import('./auth-ByhJp69L.mjs')
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (typeof __props.name === "string") {
        _push(ssrRenderComponent(unref(__nuxt_component_1$1), mergeProps({ name: __props.name }, unref(iconProps), _attrs), null, _parent));
      } else {
...
const ipxRuntime$ry_459oSdJPOmXNxw55Xw4e8XquxW3F57oFteMY8LuToo = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$ry_459oSdJPOmXNxw55Xw4e8XquxW3F57oFteMY8LuToo, defaults: {} }
  }
};
      ...
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(props).chip ? _sfc_main$c : unref(Primitive)), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              unref(props).src && !error.value ? (openBlock(), createBlock(resolveDynamicComponent(as.value.img || unref(__nuxt_component_0$1)), mergeProps({
                key: 0,
                src: unref(props).src,
                alt: unref(props).alt,
                width: sizePx.value,
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CL70r2yv.mjs').then((m) => m.default || m)),
  loader: defineAsyncComponent(() => import('./loader-qDCNdwXT.mjs').then((m) => m.default || m))
};
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtLayout, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="bg-gray-50 h-full"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_NuxtPage, null, null, _parent3, _scopeId2));
                  _push3(`</div>`);
                } else {
                  return [
                    createVNode("div", { class: "bg-gray-50 h-full" }, [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C7IOq1mc.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BQpNUri6.mjs'));
...
export { navigateTo as A, __nuxt_component_0$1 as B, Primitive as P, __nuxt_component_0$2 as _, __nuxt_component_1$1 as a, useRouter as b, useCollection as c, createContext as d, entry_default as default, useForwardExpose as e, Presence_default as f, getActiveElement as g, useComponentProps as h, injectConfigProviderContext as i, useAppConfig as j, useFieldGroup as k, useComponentIcons as l, _sfc_main$e as m, _sfc_main$b as n, useForwardProps as o, get as p, useSeoMeta as q, useIsLoadingStore as r, useAuthStore as s, tv as t, useHead as u, useUserSession as v, useFetch as w, _sfc_main$8 as x, defineNuxtRouteMiddleware as y, useState as z };
