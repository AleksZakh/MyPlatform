...
export default defineEventHandler(async (event) => {
  ...
  // Возвращаем быстрый статус-ответ локальному скрипту
  return {
    success: true,
    message: "Сигнал получен целевым сервером! Связь между тремя участниками успешно установлена."
  };
});
...
//       statusMessage: error.message || 'Внутренняя ошибка сервера при загрузке файла',
//     });
//   }
// });
